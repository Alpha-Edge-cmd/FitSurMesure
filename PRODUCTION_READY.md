...
Audit généré le 2026-07-28 20:57 par `scripts/production_check.py` (Phase 24/24).
...
9 tables créées ; données utilisateur toutes vides, catalogue d'exercices pré-chargé (365 exercices) — dossier isolé /sessions/epic-affectionate-shannon/tmp/fitsurmesure_audit_7nk9oj21
...
0.21s (sous le seuil indicatif 5.0s)
...
Commande e2de7b94777b4a25b883afcc0226bcbf créée et marquée payée
...
365 exercices importés (créés=0, maj=365, invalides ignorés=0) en 0.21s
...
PDF valide généré (23560 octets) en 0.09s
